                    ...
                    <div class="row shop_wrapper grid_3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.php" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/dara.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Dara</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.php" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/merpati.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Merpati</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.php" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/tekukur.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-18%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Tekukur</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/beo.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="new">Baru</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Beo</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/cucak ijo.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Cucak Hijau</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/jalak bali.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Jalak Bali</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star-half-o"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/serak jawa.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Hantu Serak Jawa</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/cendet.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-18%</span>
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/parkit.png" alt="Product" />
                                    </a>
                                    <span class="badges">
                                            <span class="sale">-20%</span>
                                    </span>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.html">Burung Parkit</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="single-product.php" class="image">
                                        <img class="fit-image" src="assets/images/products/medium-product/pleci.png" alt="Product" />
                                    </a>
                                    <div class="action-wrapper">
                                        <a href="#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                        <a href="wishlist.php" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="single-product.php">Burung Pleci</a></h5>
                                    <span class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star-half-o"></i>
                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                        <li class="page-item">
                                        <a class="page-link rounded-0" href="shop-list-fullwidth.php" aria-label="Next">
                                            <span aria-hidden="true">&laquo;</span>
                                            </a>
                                    <li class="page-item"><a class="page-link" href="shop-list-fullwidth.php">1</a></li>
                                    <li class="page-item"><a class="page-link active" href="shop-list-fullwidth2.php">2</a></li>
                                    <li class="page-item"><a class="page-link" href="shop-list-fullwidth3.php">3</a></li>
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="shop-list-fullwidth3.php" aria-label="Next">
                                ...
                                <div class="sidebar-body product-list-wrapper mb-n6">
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img class="fit-image first-image" src="assets/images/products/medium-product/kakatua.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.php" class="image">
                                                    <img class="fit-image first-image" src="assets/images/products/medium-product/love bird.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
                                    ...
                                    <div class="single-product-list mb-6">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img class="fit-image first-image" src="assets/images/products/medium-product/parkit.png" alt="Product Image">
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Product List Thumb End -->
