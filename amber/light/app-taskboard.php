        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="app-inbox.php"><i class="icon-envelope"></i><span>Kotak Masuk</span></a></li>
                    ...
                    <li class="active"><a href="app-taskboard.php"><i class="icon-list"></i><span>Papan tugas</span></a></li>                    
