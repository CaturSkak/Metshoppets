                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-auth-small" action="index.php">
                                ...
                                <div class="bottom">
                                    <span class="helper-text m-b-10"><i class="fa fa-lock"></i><a href="page-forgot-password.php"> Lupa Kata Sandi ?</a></span>
                                    <span>Tidak Punya Akun? <a href="page-register.php">Daftar</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
