        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    ...
                    <a href="blog-post.php" class="btn btn-sm btn-primary" title="">Buat Baru</a>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col mb-8 col-17 col-md-6">
                    <div class="single-blog-wrapper">
                        <img class="img-fluid" src="../assets/images/111.jpg" alt="img">
                        <div class="blog-content">                    
                            <div class="content">
                ...
                <div class="col mb-8">
                    <div class="single-blog-wrapper">
                        <img class="img-fluid" src="../assets/images/131.jpg" alt="img">
                        <div class="body">                    
                            <div class="content">
                                ...
                                <i class="btn fa fa-eye-slash" href=""></i>
                            </div>
                        </div>                        
                    </div>
                </div>
                ...
                <div class="col mb-8">
                    <div class="single-blog-wrapper">
                        <img class="img-fluid" src="../assets/images/212.jpg" alt="img">
                        <div class="body">                    
                            <div class="content">
