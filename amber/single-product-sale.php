            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="breadcrumb-wrapper">
                        <h2 class="breadcrumb-title">Soldout Products</h2>
                        <ul>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="product-head mb-3">
                            <h2 class="product-title">Soldout Products</h2>
                        </div>
                        <!-- Product Head End -->
                        ...
                        <div class="product-inventroy mb-3">
                            ...
                            <span class="inventory-varient">Out of Stock</span>
                        </div>
                        ...
                        <div class="cart-btn action-btn mb-6">
                            <div class="action-cart-btn-wrapper d-flex">
                                <div class="add-to_cart">
                                    <a class="btn btn-primary text-white rounded-0 disabled" href="#/">Add to cart</a>
                                </div>
