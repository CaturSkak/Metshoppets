                ...
                <div class="col-lg-9 col-12">
                    ...
                    <div class="shop_toolbar_wrapper justify-content-center mt-10">
                        ...
                        <div class="shop-top-bar-right">
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link active" href="shop-list-fullwidth.php">1</a></li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link rounded-0" href="shop-list-fullwidth2.php" aria-label="Next">
