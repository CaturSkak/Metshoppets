...
<head>
<title>:: HexaBit Dark :: Form Validation</title>
<meta charset="utf-8">
...
<div id="wrapper">
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="index.html"><img src="../assets/images/icon-light.svg" alt="HexaBit Logo" class="img-fluid logo"><span>HexaBit</span></a>
